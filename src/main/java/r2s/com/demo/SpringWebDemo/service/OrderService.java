...
public class OrderService {
    public List<CreateOrderRequestDTO> getListOrder(){
        ...
        CreateOrderRequestDTO order1= new CreateOrderRequestDTO(1,1000000,new Date(2022,12,12),true,1);
        CreateOrderRequestDTO order2= new CreateOrderRequestDTO(2,1500000,new Date(2022,12,12),true,1);
